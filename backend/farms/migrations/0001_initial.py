# Generated by Django 3.2 on 2021-05-04 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
                ('minimum_duration', models.DurationField(default=datetime.timedelta(days=30))),
                ...
                ('subscription_cost', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='INR', max_digits=14)),
                ('farm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='farm', to='farms.farm')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscription', to='farms.subscription')),
            ],
        ),
        migrations.CreateModel(
            name='FarmPicture',
